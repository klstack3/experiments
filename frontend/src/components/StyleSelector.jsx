  ...
  const styles = [
    {
      ...
      features: ['Professional suit', 'Neutral background', 'Classic lighting', 'Conservative style'],
    ...
    },
    {
      ...
      features: ['Contemporary attire', 'Artistic background', 'Dynamic lighting', 'Modern aesthetic'],
      preview: '/api/placeholder/300/400'
    },
    {
      ...
      features: ['Executive attire', 'Premium backdrop', 'Studio lighting', 'Authority presence'],
      preview: '/api/placeholder/300/400'
    }
  ];
